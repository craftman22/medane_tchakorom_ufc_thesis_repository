...
#experimenting
# SRC_DIRS :=     src/asynchronous-multisplitting-asynchronous-minimization-semi-local
# SRC_DIRS :=    src/asynchronous-multisplitting src/synchronous-multisplitting  src/synchronous-multisplitting-synchronous-minimization-global src/asynchronous-multisplitting-asynchronous-minimization-global src/synchronous-multisplitting-synchronous-minimization-semi-local
...
SRC_DIRS :=  src/synchronous-multisplitting-synchronous-minimization-global src/asynchronous-multisplitting-asynchronous-minimization-global src/synchronous-multisplitting src/asynchronous-multisplitting src/synchronous-multisplitting-synchronous-minimization-local src/asynchronous-multisplitting-asynchronous-minimization-local src/synchronous-multisplitting-synchronous-minimization-semi-local src/asynchronous-multisplitting-asynchronous-minimization-semi-local src/gmres_solution
