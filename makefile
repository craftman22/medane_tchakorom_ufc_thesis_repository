...
# Synchronous
#SRC_DIRS :=   src/asynchronous-multisplitting-asynchronous-minimization-global src/asynchronous-multisplitting-asynchronous-minimization-local src/asynchronous-multisplitting-asynchronous-minimization-semi-local src/gmres_solution

#experimenting
# SRC_DIRS :=  src/synchronous-multisplitting-synchronous-minimization-global src/gmres_solution
