...
#define TAG_SEND_RCV_RESPONSE 120



#define VERDICT_POSITIVE   1
#define VERDICT_NEGATIVE   -1


#define RESPONSE_POSITIVE   1
#define RESPONSE_NEUTRAL   0
#define RESPONSE_NEGATIVE   -1
